...
static int interleaving[3] = {2, 3, 1};
...
static void wait_wrapper_idiom1(int threadid) {
	if (threadid == 1)
	{	
...
static void signal_wrapper_idiom1(int threadid) {
	if (threadid == 1)
	{
...
// static void readDebug(int* addr, int threadid) {
// 	if (threadid != 0)
// 	{
// 		PIN_GetLock(&pinLock, threadid+1);
// 		cout << "Debug: value of read var: " << *addr 
// 		<< " from thread " << threadid << endl;
// 		PIN_ReleaseLock(&pinLock);
// 	}
// }

// static void writeDebug(int* addr, int threadid) {
// 	if (threadid != 0)
// 	{
// 		PIN_GetLock(&pinLock, threadid+1);
// 		cout << "Debug: value of written var: " << *addr 
// 		<< " from thread " << threadid << endl;
// 		PIN_ReleaseLock(&pinLock);
...
static void idiom_1_wrapper(INS ins, void *v) {
	...
	if (INS_IsMemoryRead(ins) || INS_IsMemoryWrite(ins))
	{
		...
		// {
		// 	INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)readDebug, 
		// 		IARG_MEMORYREAD_EA, 
		// 		IARG_THREAD_ID, 
		// 		IARG_END);
		// }
		...
		// {
		// 	INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)writeDebug, 
		// 		IARG_MEMORYWRITE_EA, 
		// 		IARG_THREAD_ID, 
		// 		IARG_END);
		// }
		...
		// if (INS_IsMemoryWrite(ins))
		// {
		// 	INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)wait_wrapper_idiom1, IARG_MEMORYWRITE_EA, IARG_THREAD_ID, IARG_END);
		// 	if (INS_IsValidForIpointAfter(ins))
		// 	{
		// 		INS_InsertCall(ins, IPOINT_AFTER, (AFUNPTR)signal_wrapper_idiom1, IARG_MEMORYWRITE_EA, IARG_THREAD_ID, IARG_END);
		// 	}
		// }

		// INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)wait_wrapper_idiom1, IARG_THREAD_ID, IARG_, IARG_END);
		// if (INS_IsValidForIpointAfter(ins))
		// {
		// 	INS_InsertCall(ins, IPOINT_AFTER, (AFUNPTR)signal_wrapper_idiom1, IARG_THREAD_ID, IARG_END);
		// }
	}
}
