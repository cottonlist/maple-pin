...
// static void wait_wrapper_idiom3 (int threadid) {
// 	if (threadid == 1)
// 	{
// 		cout << "Thread " << threadid << " ins " << ins_no_th1 << " starting..." << endl;
// 		if (interleaving[0] == 1 && interleaving[4] == ins_no_th1) {
...
// 		if (interleaving[0] == 2 && interleaving[4] == ins_no_th2) {
...
// static void signal_wrapper_idiom3 (int threadid) {
// 	if (threadid == 1)
// 	{
...
// 			PIN_ReleaseLock(&lock1);
// 		}
// 		if (interleaving[0] == 2 && interleaving[3] == ins_no_th1)
// 		{
// 			PIN_GetLock(&lock1, threadid);
...
// 			PIN_ReleaseLock(&lock2);
// 		}
// 		if (interleaving[0] == 1 && interleaving[3] == ins_no_th2)
// 		{
// 			PIN_GetLock(&lock2, threadid);
// 			PIN_SemaphoreSet(&sem2);
// 			PIN_ReleaseLock(&lock2);
...
// 	{
// 		cout << "Thread " << threadid << " ins " << ins_no_th1 << " starting..." << endl;
// 		if (interleaving[2] == 1 && interleaving[3] == ins_no_th1)
// 		{
// 			PIN_GetLock(&lock1, threadid);
// 			PIN_SemaphoreWait(&sem1);
// 			PIN_ReleaseLock(&lock1);
...
// 	{
// 		cout << "Thread " << threadid << " ins " << ins_no_th2 << " starting..." << endl;
// 		if (interleaving[2] == 2 && interleaving[3] == ins_no_th2)
// 		{
// 			PIN_GetLock(&lock2, threadid);
// 			PIN_SemaphoreWait(&sem1);
// 			PIN_ReleaseLock(&lock2);
...
// static void idiom_3_wrapper(INS ins, void *v) {
// 	IMG img = IMG_FindByAddress(INS_Address(ins));
// 	if (!IMG_Valid(img) || !IMG_IsMainExecutable(img))
// 	{
// 		return;
// 	}
// 	INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)wait_wrapper_idiom3, IARG_THREAD_ID, IARG_END);
// 	if (INS_IsValidForIpointAfter(ins))
// 	{
// 		INS_InsertCall(ins, IPOINT_AFTER, (AFUNPTR)signal_wrapper_idiom3, IARG_THREAD_ID, IARG_END);
// 	}
// }
...
// 		return;
// 	}
// 	INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)wait_wrapper_idiom1, IARG_THREAD_ID, IARG_END);
// 	if (INS_IsValidForIpointAfter(ins))
// 	{
